This project is a set of pre-written code for backend api application. You just need to focus to your business and implement it instead of spending hours for building a new project.
